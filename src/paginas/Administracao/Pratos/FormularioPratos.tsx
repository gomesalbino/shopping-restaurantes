...
const FormularioPratos = () => {
    ...
    const [nomePrato, setNomesPrato] = useState('');
                    ...
                    <Paper sx={{ p: 2 }}>
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", flexGrow: 1 }}>
                            <Box component="form" onSubmit={aoSubmeterForm} sx={{width: "100%"}}>
                                <Typography variant="h3" marginTop="35px" marginBottom="20px"> Formulário de Pratos </Typography>
                                <TextField
                                    value={nomePrato}
                                    onChange={evento => setNomesPrato(evento.target.value)}
                                    label="Nome do Prato"
                                    variant="standard"
                                    fullWidth
                                    required
